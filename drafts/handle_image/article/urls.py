...
urlpatterns = [
    ...
    path(
        "list-article-titles/<username>/",
        list_views.article_titles,
        name="author_articles",
    ),
    path("like_article/", list_views.like_article, name="like_article"),
    path("article-tag/", view=views.article_tag, name="article_tag"),
    path("del-article-tag/", view=views.del_article_tag, name="del_article_tag"),
]
